  ...
  return (
    <section className="contain">
      <ul className="grid grid-cols-[repeat(4,auto)] gap-4">
        <Gig
          thumbnail="https://images.unsplash.com/photo-1552308995-2baac1ad5490?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
